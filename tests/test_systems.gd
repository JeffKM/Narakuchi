...
func _test_gyujong_pet() -> void:
  ...
  check(Events.events_for("miho") == ["mine", "kinder"], "미호 보유 이벤트 = 지뢰계·유치원")
  check(Events.events_for("bana") == ["mine", "kinder"], "바나 보유 이벤트 = 지뢰계·유치원")
  check(Events.events_for("mel") == ["mine", "kinder"], "멜 보유 이벤트 = 지뢰계·유치원")
