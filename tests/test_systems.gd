...
func _test_gyujong_pet() -> void:
  ...
  check(Events.events_for("miho") == ["mine", "kinder", "hiphop", "butler", "xmas"], "미호 보유 이벤트 = 전체 5종")
  check(Events.events_for("bana") == ["mine", "kinder", "hiphop", "butler", "xmas"], "바나 보유 이벤트 = 전체 5종")
  check(Events.events_for("mel") == ["mine", "kinder", "hiphop", "butler", "xmas"], "멜 보유 이벤트 = 전체 5종")
